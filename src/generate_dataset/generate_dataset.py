...
from src.generate_dataset.args import argument_parser
from src.generate_dataset.args import load_args_settings
...
def generate_dataset_poisson_regression(args):
    ...
    mean_y = X.dot(w)
    y = np.random.poisson(lam=mean_y)  # (number_samples, 1)
